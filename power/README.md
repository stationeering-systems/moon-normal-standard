...
This directory contains IC10 code for normal-tier Power Systems.  It's designed for modular integration into base infrastructure, in support of power grid architecture.

For full design rationale, system theory, and detailed guides, visit the Stationeering Systems Substack:
- [Microgrid Architecture for Resilient Power Systems](https://stationeering.substack.com/p/microgrid-architecture)
